...
public static class MessagingQueues
{
    ...
    public const string PerformPayment = "payment.perform";
    public const string PaymentSuccessful = "payment.successful";

    public static readonly IReadOnlyList<string> All =
        [OrderSubmitted, InventoryReserved, InventoryReservationFailed, InventoryReleased, PerformPayment, PaymentSuccessful];
}
